...
const renderDocument = (doc, commentCount, comments, hasFavorited, match, history) => (doc ? (
...
const ViewDocument = ({
  ...
  !loading ? renderDocument(doc, commentCount, comments, hasFavorited, match, history) : <Loading />
);
